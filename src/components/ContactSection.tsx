...
const ContactSection: React.FC = () => {
  ...
  const SendButton = () => (
    <button
      ...
      className={`group relative w-[130px] h-[48px] md:h-[54px] items-center justify-center rounded-xl overflow-hidden cursor-pointer flex transition-all duration-300 ${sentStatus === 'idle' ? 'bg-[#161c2d] hover:bg-[#2563eb]' : 'bg-[#2563eb]'
